...
using Buffet.ViewModels.Buffet.Convidado;
...
namespace Buffet.Controllers
{
    public class EventoController : Controller
    {
        ...
        public EventoController(LocalService localService, ClientService clientService, 
        ...
        [HttpGet]
        public IActionResult CreateConvidado(Guid id)
        {
            var evento = _eventoService.GetById(id);
            var situacaoConvidado = _situacaoConvidadoService.GetAll().ToList();
            CriarConvidadoViewModelEvento viewModel = new CriarConvidadoViewModelEvento();
            viewModel.Evento = evento;
            viewModel.Situacao = situacaoConvidado;
            return View("~/Views/Admin/Convidado/Register.cshtml", viewModel);
            //chama a tela de convidado passando o view com id do evento
        }


        //[HttpPost]
        //public IActionResult CreateConvidado()
        //{
        //    //PENDENTE
        //    //chama a tela de convidado passando o view com id do evento
        //}
